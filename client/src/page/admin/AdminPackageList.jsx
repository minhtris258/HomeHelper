  ...
  return (
    <div className="p-8">
      <div className="flex justify-between items-center mb-8">
        <h2 className="text-2xl font-bold flex items-center gap-2"><Package/> Quản lý gói dịch vụ</h2>
        <Link to="/admin/packages/create" className="bg-blue-600 text-white px-6 py-3 rounded-xl font-medium flex items-center gap-2">
      ...
      <div className="bg-white rounded-3xl  shadow-sm overflow-hidden">
        <table className="w-full text-left">
          <thead className="bg-slate-50 ">
            <tr>
              <th className="px-6 py-4 font-medium text-slate-700">Tên gói</th>
              <th className="px-6 py-4 font-medium text-slate-700">Giá</th>
              <th className="px-6 py-4 font-medium text-slate-700">Thời hạn</th>
              <th className="px-6 py-4 font-medium text-slate-700 text-right">Thao tác</th>
            </tr>
          </thead>
          <tbody>
            {packages.map(pkg => (
