  ...
  return (
    <div className="max-w-7xl mx-auto py-24 px-4 font-sans text-left">
      ...
      <div className="text-center mb-20">
        <h1 className="text-4xl md:text-5xl font-bold text-slate-900 mb-6 tracking-tight uppercase">
          Nâng cấp đặc quyền <span className="text-blue-600">Premium</span>
        </h1>
        <h4 className="text-slate-500 max-w-2xl mx-auto  text-lg leading-relaxed italic">
          Dành riêng cho chủ nhà: Mở khóa thông tin liên hệ và đưa bài đăng lên
          vị trí ưu tiên.
        </h4>
      </div>
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-10 items-stretch">
        {packages.map((pkg, index) => (
          ...
          >
            {index === 1 && (
              <div className="absolute -top-6 left-1/2 -translate-x-1/2 bg-blue-600 text-white px-8 py-2.5 rounded-full text-[10px] font-bold uppercase tracking-[0.2em] shadow-lg shadow-blue-200">
                Lựa chọn tốt nhất
              </div>
            )}
            ...
            <div className="mb-12 border-b border-slate-50 pb-8 text-center">
              ...
              <h3 className="text-2xl font-bold text-slate-800 mb-4 uppercase tracking-tight">
                {pkg.packageName}
              </h3>
            ...
            <button
              ...
              className={`w-full py-5 rounded-[24px] font-bold text-sm uppercase tracking-widest transition-all active:scale-95 shadow-xl ${
                index === 1
