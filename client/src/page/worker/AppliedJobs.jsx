      ...
      {loading ? (
        ...
        <div className="grid gap-4">
          {apps.map((app) => (
            <div
              key={app.id}
              className="bg-white p-6 rounded-2xl border flex flex-col md:flex-row justify-between items-center gap-4 hover:shadow-md transition-all"
            >
              ...
              <div
                className={`px-4 py-2 rounded-full border text-xs font-bold uppercase flex items-center gap-2 ${getStatusStyle(app.status)}`}
              >
