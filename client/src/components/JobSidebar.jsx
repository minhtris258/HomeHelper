      ...
      <div className="bg-white rounded-[32px] border border-slate-100 p-6 shadow-sm sticky top-24">
        <div className="flex items-center justify-between mb-8">
          <div className="flex items-center gap-2 text-slate-800 text-left">
            ...
            <h2 className="font-bold   tracking-tight">Lọc kết quả</h2>
          </div>
          <button 
            onClick={clearFilters}
            className="text-[10px] font-bold text-blue-600 hover:text-red-500 uppercase tracking-widest transition-colors"
          >
            Xóa lọc
          </button>
        </div>
        ...
        <div className="space-y-8 text-left">
          ...
          <div className="space-y-3">
            ...
            <select
              ...
              className="w-full p-4 text-xs bg-slate-50 border-2 border-transparent focus:border-blue-500 rounded-2xl outline-none font-bold text-slate-600 appearance-none cursor-pointer transition-all"
            >
              ...
              {["Full-time", "Part-time", "Hourly"].map((type) => (
                <button
                  ...
                  className={`text-left px-4 py-3 rounded-xl font-bold text-sm transition-all border-2 ${
                    ...
                    : "bg-white border-slate-100 text-slate-500 hover:border-blue-200 text-xs"
                  }`}
                >
          ...
          <div className="space-y-3">
            ...
            <input
              ...
              onChange={handleInputChange}
              className="w-full p-4 bg-slate-50 border-2 border-transparent text-xs focus:border-blue-500 rounded-2xl outline-none font-bold text-slate-600 transition-all"
            />
