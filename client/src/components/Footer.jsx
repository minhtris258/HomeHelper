      ...
      <div className="max-w-[1440px] mx-auto">
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-5 gap-12 mb-12 container">
          ...
          <div className="lg:col-span-2">
            ...
            <p className="text-sm leading-7 mb-8 max-w-sm">
              Nền tảng giúp việc nhà hàng đầu Việt Nam. Chúng tôi mang đến sự an
              tâm và tiện nghi cho mọi gia đình thông qua đội ngũ cộng tác viên
              chuyên nghiệp.
            </p>
            <div className="flex gap-4">
              <a
                href="#"
                className="p-2.5 rounded-lg bg-slate-800 hover:bg-blue-600 hover:text-white transition-all transform hover:-translate-y-1"
              >
                <Facebook size={20} />
              </a>
              <a
                href="#"
                className="p-2.5 rounded-lg bg-slate-800 hover:bg-red-600 hover:text-white transition-all transform hover:-translate-y-1"
              >
                <Youtube size={20} />
              </a>
              <a
                href="#"
                className="p-2.5 rounded-lg bg-slate-800 hover:bg-gradient-to-tr from-yellow-500 via-red-500 to-purple-500 hover:text-white transition-all transform hover:-translate-y-1"
              >
                <Instagram size={20} />
              </a>
            </div>
          ...
          <div>
            ...
            <div className="space-y-5 text-sm">
              <div className="flex items-start gap-3">
                ...
                <span>
                  Toà nhà Innovation, CVPM Quang Trung, Quận 12, TP. Hồ Chí Minh
                </span>
              </div>
        ...
        <div className="flex flex-col md:flex-row justify-between items-center gap-6 container">
          ...
          <div className="flex items-center gap-6 opacity-70">
            ...
            <div className="flex gap-4 font-bold italic text-slate-500">
              <span className="hover:text-blue-400 cursor-default transition">
                VISA
              </span>
              <span className="hover:text-orange-400 cursor-default transition">
                MASTER
              </span>
              <span className="hover:text-pink-500 cursor-default transition">
                MOMO
              </span>
            </div>
          </div>
